...
copyright = ("2019, Theodore Fobe. Project structure based on the "
...
texinfo_documents = [
    (master_doc, 'geometry_analysis', 'geometry_analysis Documentation',
     author, 'geometry_analysis', 'Basic geometry manipulations of molecules. This package was built as a tutorial from the MolSSI Software Summer School.',
     'Miscellaneous'),
]
